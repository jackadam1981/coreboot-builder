...
/* Note: EC_ENABLE_BATTERY_DEVICE is NOT defined (Chromebox does not have battery) */
/* Note: EC_HOST_EVENT_BATTERY and EC_HOST_EVENT_LID are NOT included (Chromebox specific) */
